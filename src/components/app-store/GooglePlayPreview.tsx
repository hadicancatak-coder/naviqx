    ...
    <div className="flex flex-col items-center py-lg">
      ...
      <div className="w-[300px] rounded-[28px] border-[3px] border-foreground/20 bg-background shadow-xl overflow-hidden">
        ...
        <div className="px-md pb-lg space-y-sm" dir={dir}>
          ...
          {/* Install button */}
          <button className="w-full bg-primary text-primary-foreground text-body-sm font-medium py-2 rounded-lg">
            Install
          </button>
          ...
          <div className="flex gap-xs overflow-x-auto pb-xs">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-[100px] h-[180px] rounded-lg bg-muted flex-shrink-0 flex items-center justify-center"
              >
                <span className="text-metadata text-muted-foreground">Shot {i}</span>
              </div>
            ))}
          </div>
          ...
          {/* Full Description */}
          <p className="text-metadata text-muted-foreground line-clamp-3">
